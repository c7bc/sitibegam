        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex items-center">
            <a className="block text-brand-500 flex items-center gap-2 mt-2" href="/">
              <svg width="60" height="60" viewBox="0 0 285 285" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M145.41 238.148L147.697 238.004C147.496 242.931 147.696 248.991 147.727 254C146.543 249.297 145.988 243.071 145.41 238.148Z" fill="#CEECF8" fillOpacity="0.0117647"/>
                <path d="M100.287 123.461C102.333 124.921 104.759 128.49 106.3 130.61C95.5264 140.931 95.7604 146.92 95.8054 161.227C95.8294 168.788 95.7754 176.722 95.7764 184.318L95.8374 260.657C95.8404 262.689 96.1304 275.57 95.6394 276.655L94.8854 276.637C91.5064 275.408 89.7204 274.572 86.5154 272.925C87.0334 262.828 86.6884 249.861 86.6894 239.532L86.6844 178.396C86.6834 169.502 86.4594 160.083 86.8094 151.244C87.3154 138.442 90.9844 131.89 100.287 123.461Z" fill="#66C61C"/>
              </svg>
