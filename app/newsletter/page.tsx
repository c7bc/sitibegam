...
import NewsletterFormV2 from '@/components/newsletter-form-v2';
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8">
          <div className="lg:w-2/3">
            <PageTitle
              title="Newsletter"
              description="Inscreva-se e receba periodicamente informações sobre o sindicato, direitos trabalhistas, eventos e muito mais."
            />

            <NewsletterFormV2 siteId={siteId} />
          </div>
