...
import SindicalizacaoForm from '@/components/sindicalizacao-form';
...
async function SindicalizeSeContent() {
  'use cache';
  cacheLife('days');
  cacheTag('sindicalize-se-page-content');
  ...
  return (
    <main className="flex-1">
      <SindicalizacaoForm siteId={String(site.id)} />
