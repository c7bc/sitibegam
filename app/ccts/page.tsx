...
export default async function CctsPage() {
  'use cache';
  cacheLife('days');
  cacheTag('ccts-page', 'acts-ccts');
  ...
  return (
    <div className="bg-white">
      ...
      <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'CCTs' }]} />

      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8">
          <div className="lg:w-2/3">
            <PageTitle
              title="Convenções Coletivas de Trabalho (CCTs)"
              description="Convenções aplicáveis a toda a categoria dos trabalhadores SITIBEGAM do Estado."
            />

            <ActsCctsList
              items={ccts}
              emptyMessage="Nenhuma convenção coletiva publicada ainda."
            />
          </div>
