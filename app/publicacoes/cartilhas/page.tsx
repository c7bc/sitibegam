...
export default async function CartilhasPage() {
  ...
  if (site) {
    ...
    items = posts.map(transformPostToNewsItem).filter(n => n.category === 'Cartilha');
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8">
          <div className="lg:w-2/3">
            <PageTitle
              title="Cartilhas"
              description="Materiais educativos e guias de orientação publicados pelo sindicato."
            />
            ...
            {items.length > 0 ? (
              ...
              <div className="border border-gray-200 p-6 text-center text-sm text-gray-500">
                Nenhuma cartilha publicada ainda.
              </div>
            )}
          </div>
