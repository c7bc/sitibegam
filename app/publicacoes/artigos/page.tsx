...
export default async function ArtigosPage() {
  ...
  if (site) {
    ...
    items = posts.map(transformPostToNewsItem).filter(n => n.category === 'Artigo');
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="flex flex-col lg:flex-row lg:items-start gap-8">
          <div className="lg:w-2/3">
            <PageTitle
              title="Artigos"
              description="Artigos de opinião, análises e textos aprofundados sobre a categoria."
            />
